      ...
      <Container className="container-fluid">
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              <h2 id="mainHeader">Bem vindo(a) a Won Games!</h2>
              <P>Ao lado você poderá inserir diferentes jogos, categorias e publishers para a nossa loja de jogos!</P>
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              ...
              <P style={{ marginTop: 7, marginBottom: 0 }}>Em caso de dúvidas e/ou sugestões, utilize um de nossos links.</P>
              <ALink
